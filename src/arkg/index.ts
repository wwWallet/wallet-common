...
import { byteArrayEquals, concat, fromBase64Url, OS2IP, toBase64, toHex, toU8 } from '../utils/util';
import { COSE_ALG_ARKG_P256ADD_ECDH } from '../cose';
import { ParsedCOSEKeyArkgPubSeed, ParsedCOSEKeyEc2Public } from '../cose';
	...
	return {
		generateKeypair: async (): Promise<[ec.Point, bigint]> => {
			...
			return [
				...
				OS2IP(fromBase64Url(jwk.d as string)),
			];
		},
